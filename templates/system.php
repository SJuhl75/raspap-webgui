          ...
          <div role="tabpanel" class="tab-pane active" id="system">
            <div class="row">
              <div class="col-lg-6">
                ...
                <div><?php echo htmlspecialchars($hostname, ENT_QUOTES);    ?></div>
                <div class="info-item"><?php echo _("IPv4 Address");        ?></div>
                <div><?php echo htmlspecialchars($public_ip, ENT_QUOTES);   ?>
                  <a class="text-gray-500" href="https://ipapi.co/<?php echo($public_ip); ?>" target="_blank" rel="noopener noreferrer"><i class="fas fa-external-link-alt ml-2"></i></a> 
                </div> 
                <div class="info-item"><?php echo _("Pi Revision");         ?></div>
                <div><?php echo htmlspecialchars(RPiVersion(), ENT_QUOTES); ?></div>
                <div class="info-item"><?php echo _("Uptime");              ?></div>
                <div><?php echo htmlspecialchars($uptime, ENT_QUOTES);      ?></div>
                <div class="info-item"><?php echo _("Battery status");         ?></div>
                <div><?php echo $pwrstate;      ?></div>
                <div class="progress mb-2" style="height: 20px;">
                  <div class="progress-bar bg-<?php echo htmlspecialchars($batcap_status, ENT_QUOTES); ?>"
                                              role="progressbar" aria-valuenow="<?php echo htmlspecialchars($batcap, ENT_QUOTES); ?>" aria-valuemin="0" aria-valuemax="100"
                                              style="width: <?php echo htmlspecialchars($batcap, ENT_QUOTES); ?>%"><?php echo htmlspecialchars($batcap, ENT_QUOTES); ?>%
                  </div>
                </div>
